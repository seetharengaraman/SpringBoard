...
market data from multiple stock exchanges. This specifically works on ingested data to provide
...
if __name__ == '__main__':
    ...
    ingest_bucket_name = 'ingest_trade_quote'
    analysis_bucket_name = 'trade_quote_analysis'
    data_path = f"gs://{ingest_bucket_name}/output"
    output_path = f"gs://{analysis_bucket_name}/quote-trade-analytical"
